...
public class Super_Smash_Bros_Ultimate extends AppCompatActivity {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_super_smash_bros_ultimate);

        // 1) Récupérer le code du jeu transmis depuis MainActivity
        //    ici ce sera "rocket_league"
        String jeu = getIntent().getStringExtra("jeu");
        if (jeu == null) jeu = "Super Smash Bros. Ultimate";  // valeur par défaut si nécessaire
        ...
        lv.setOnItemClickListener((parent, view, pos, id2) -> {
            ...
            Toast.makeText(
                    Super_Smash_Bros_Ultimate.this,
