...
public class League_of_Legends_LEC extends AppCompatActivity {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_league_of_legends_lec);

        // 1) Récupérer le code du jeu transmis depuis MainActivity
        //    ici ce sera "rocket_league"
        String jeu = getIntent().getStringExtra("jeu");
        if (jeu == null) jeu = "League_of_Legends";  // valeur par défaut si nécessaire
